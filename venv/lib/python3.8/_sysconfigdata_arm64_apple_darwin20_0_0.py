...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CFLAGS': '-fno-strict-aliasing -Wsign-compare -Wunreachable-code -DNDEBUG '
           ...
           '-fdebug-prefix-map=/config/workspace/Demo-pipeline/venv=/usr/local/src/conda-prefix '
 ...
 'LIBPL': '/config/workspace/Demo-pipeline/venv/lib/python3.8/config-3.8-darwin',
