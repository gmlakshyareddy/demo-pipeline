...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIG_ARGS': "'--prefix=/config/workspace/Demo-pipeline/venv' "
                ...
                "-I/config/workspace/Demo-pipeline/venv/include' "
                "'CPP=/config/workspace/Demo-pipeline/venv/bin/powerpc64le-conda_cos7-linux-gnu-cpp' "
 ...
 'LIBPL': '/config/workspace/Demo-pipeline/venv/lib/python3.8/config-3.8-powerpc64le-linux-gnu',
