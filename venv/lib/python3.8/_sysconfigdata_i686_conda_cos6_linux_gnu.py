...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIG_ARGS': "'--prefix=/config/workspace/Demo-pipeline/venv' "
                ...
                "-I/config/workspace/Demo-pipeline/venv/include' "
                "'CPP=/config/workspace/Demo-pipeline/venv/bin/i686-conda_cos6-linux-gnu-cpp' "
 ...
 'LIBPL': '/config/workspace/Demo-pipeline/venv/lib/python3.8/config-3.8-i386-linux-gnu',
