...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'aarch64-conda_cos7-linux-gnu-gcc -pthread -shared -Wl,-O2 '
              ...
              '-Wl,-rpath,/config/workspace/Demo-pipeline/venv/lib '
 ...
 'CONFIGURE_LDFLAGS': '-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro '
                      ...
                      '-Wl,-rpath,/config/workspace/Demo-pipeline/venv/lib '
                      '-L/config/workspace/Demo-pipeline/venv/lib',
 'CONFIG_ARGS': "'--prefix=/config/workspace/Demo-pipeline/venv' "
                ...
                "-I/config/workspace/Demo-pipeline/venv/include' "
                "'CPP=/config/workspace/Demo-pipeline/venv/bin/aarch64-conda_cos7-linux-gnu-cpp' "
 ...
 'LIBFFI_INCLUDEDIR': '/config/workspace/Demo-pipeline/venv/include',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/config/workspace/Demo-pipeline/venv/lib/pkgconfig',
 'LIBPL':
     '/config/workspace/Demo-pipeline/venv/lib/python3.8/config-3.8-aarch64-linux-gnu',
 ...
 'OPENSSL_INCLUDES': '-I/config/workspace/Demo-pipeline/venv/include',
 'OPENSSL_LDFLAGS': '-L/config/workspace/Demo-pipeline/venv/lib',
